 ...
 */
public abstract class ACPOA extends org.omg.PortableServer.Servant implements
		ACOperations, org.omg.CORBA.portable.InvokeHandler {
	public AC _this() {
	...
	private static String[] _ids_list = { "IDL:corbak/AC:1.0" };
	...
	private org.omg.CORBA.portable.OutputStream _invoke_generationCertificat(
		...
		corbak.Certificat _arg_result = generationCertificat(arg0_in, arg1_in,
				arg2_in, arg3_in);
