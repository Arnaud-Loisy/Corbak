...
public class droitsInsufisantsHelper {
	...
	public static corbak.droitsInsufisants extract(org.omg.CORBA.Any a) {
		...
		if (HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
			...
			corbak.droitsInsufisantsHolder h = new corbak.droitsInsufisantsHolder(
	...
	public static org.omg.CORBA.TypeCode type() {
		if (_tc == null) {
			synchronized (org.omg.CORBA.TypeCode.class) {
				...
				_tc = orb.create_exception_tc(id(), "droitsInsufisants",
						_members);
				_working = false;
			}
		}
	 ...
	 */
	public static corbak.droitsInsufisants read(
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			corbak.droitsInsufisants value) {
