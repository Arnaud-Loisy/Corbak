...
public class AEHelper
{
     ...
     * @param t AE value
     */
    public static void insert(org.omg.CORBA.Any a, corbak.AE t)
    {
     ...
     */
    public static corbak.AE extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return corbak.AEHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:corbak/AE:1.0";
     ...
     */
    public static corbak.AE read(org.omg.CORBA.portable.InputStream istream)
    {
        return(corbak.AE)istream.read_Object(corbak._AEStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, corbak.AE value)
    {
