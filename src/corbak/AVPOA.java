 ...
 */
public abstract class AVPOA extends org.omg.PortableServer.Servant implements
		AVOperations, org.omg.CORBA.portable.InvokeHandler {
	public AV _this() {
	...
	private static String[] _ids_list = { "IDL:corbak/AV:1.0" };
