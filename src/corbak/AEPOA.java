 ...
 */
public abstract class AEPOA extends org.omg.PortableServer.Servant implements
		AEOperations, org.omg.CORBA.portable.InvokeHandler {
	public AE _this() {
	...
	private static String[] _ids_list = { "IDL:corbak/AE:1.0" };
