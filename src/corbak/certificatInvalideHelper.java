...
public class certificatInvalideHelper {
	...
	public static corbak.certificatInvalide extract(org.omg.CORBA.Any a) {
		...
		if (HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
			...
			corbak.certificatInvalideHolder h = new corbak.certificatInvalideHolder(
	...
	public static org.omg.CORBA.TypeCode type() {
		if (_tc == null) {
			synchronized (org.omg.CORBA.TypeCode.class) {
				...
				_tc = orb.create_exception_tc(id(), "certificatInvalide",
						_members);
				_working = false;
			}
		}
	 ...
	 */
	public static corbak.certificatInvalide read(
	...
	public static void write(org.omg.CORBA.portable.OutputStream ostream,
			corbak.certificatInvalide value) {
