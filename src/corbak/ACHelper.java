...
public class ACHelper
{
     ...
     * @param t AC value
     */
    public static void insert(org.omg.CORBA.Any a, corbak.AC t)
    {
     ...
     */
    public static corbak.AC extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return corbak.ACHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:corbak/AC:1.0";
     ...
     */
    public static corbak.AC read(org.omg.CORBA.portable.InputStream istream)
    {
        return(corbak.AC)istream.read_Object(corbak._ACStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, corbak.AC value)
    {
